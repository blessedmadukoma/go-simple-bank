...
// requireBodyMathAccount checks if the request body matches the generated account
...
//TestGetAccountAPI tests the GetAccount API on the server, in the account.go
func TestGetAccountAPI(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:      "InvalidID",
			accountID: 0, // minimum ID should be 1
			buildStubs: func(store *mockdb.MockStore) {
